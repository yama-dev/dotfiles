...
nnoremap <space>ff :CocCommand explorer --toggle --sources=buffer+,file+ --position left --width 50 <CR>
nnoremap <space>fa :CocCommand explorer --toggle --sources=buffer+,file+ --position left --width 50 ~/ <CR>
